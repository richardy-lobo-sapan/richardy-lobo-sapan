...
|---|---|---|---|
| [Aria — LLM Chatbot with Memory](https://github.com/richardy-lobo-sapan/llm-chatbot-memory) | Conversational AI chatbot with persistent memory and streaming responses built on Groq + Llama 3.1 | Python · Groq API · Streamlit | [Live Demo](https://llm-chatbot-memory-evq5f6hm6yhlcuxjeqwvzy.streamlit.app) |
...
| [AI Agent with Tools](https://github.com/richardy-lobo-sapan/ai-agent-tools) | AI agent that searches the web, does math, and chains multiple tools to answer complex multi-step questions | Python · LangChain · LangGraph · Gemini · Tavily | [Live Demo](https://ai-agent-tools-cwd7wrxjhyntnbicdccsri.streamlit.app) |
| [LLM API Production](https://github.com/richardy-lobo-sapan/llm-api-production) | Production-ready LLM API with RAG, Langfuse observability, and Supabase persistent storage — deployed on Railway | FastAPI · LangChain · Gemini · ChromaDB · Langfuse · Supabase · Railway | [Live API](https://llm-api-production-production.up.railway.app/docs) |
...
**AI & LLM**
`Python` `Scikit-learn` `TensorFlow` `Keras` `PyTorch` `OpenCV` `Groq API` `Anthropic API` `Llama 3.1` `LSTM` `LangChain` `ChromaDB` `RAG` `Gemini API` `LangGraph` `AI Agents` `ReAct` `Tavily` `Langfuse` `Supabase`
...
**DevOps & Cloud**
`Docker` `Railway` `GitHub Actions` `CI/CD` `Google Cloud` `Streamlit Cloud`
